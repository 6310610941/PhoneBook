...
@Composable
fun SaveNumScreen(viewModel: MainViewModel) {
    ...
    BackHandler {
        if (bottomDrawerState.isOpen) {
            ...
            MyNotesRouter.navigateTo(Screen.Phone)
        }
    }
